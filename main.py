...
that strictly adheres to the following JSON schema and do not add any extra fields. Do not add and make up any fields that are not in the JSON schema given to you.
